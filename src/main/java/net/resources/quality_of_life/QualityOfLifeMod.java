package net.resources.quality_of_life;
...
@Mod("quality_of_life")
public class QualityOfLifeMod {
	public static final Logger LOGGER = LogManager.getLogger(QualityOfLifeMod.class);
	public static final String MODID = "quality_of_life";
